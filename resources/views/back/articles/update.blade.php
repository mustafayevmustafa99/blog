...
@section('title',$article->title.' məqaləsini redaktə et')
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{route('makaleler.update',$article->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Məqalə Şəkli</label><br>
                    <img src="{{asset($article->image)}}" class="img-thumbnail rounded" width="300px">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-block">Məqaləni Redaktə Et</button>
                </div>
            </form>
        </div>
    </div>
